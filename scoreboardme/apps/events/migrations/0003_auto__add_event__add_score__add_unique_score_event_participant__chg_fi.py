...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Score'
        db.create_table(u'events_score', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Event'])),
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.UserProfile'])),
            ('score', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'events', ['Score'])

        # Adding unique constraint on 'Score', fields ['event', 'participant']
        db.create_unique(u'events_score', ['event_id', 'participant_id'])


        # Changing field 'EventRequest.event_request'
        db.alter_column(u'events_eventrequest', 'event_request_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Event']))

    def backwards(self, orm):
        # Removing unique constraint on 'Score', fields ['event', 'participant']
        db.delete_unique(u'events_score', ['event_id', 'participant_id'])

        # Deleting model 'Event'
        db.delete_table(u'events_event')

        # Deleting model 'Score'
        db.delete_table(u'events_score')


        # Changing field 'EventRequest.event_request'
        db.alter_column(u'events_eventrequest', 'event_request_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Event']))
