...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EventRequest.participant'
        db.add_column(u'events_eventrequest', 'participant',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EventRequest.participant'
        db.delete_column(u'events_eventrequest', 'participant_id')
