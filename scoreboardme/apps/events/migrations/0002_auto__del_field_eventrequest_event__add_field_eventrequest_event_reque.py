...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'events_eventrequest', 'event_request',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['core.Event']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'events_eventrequest', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='events', to=orm['core.Event']),
                      keep_default=False)
